...
\label{group___g_p_i_o___group3}\index{GPIO Alternate functions configuration function@{GPIO Alternate functions configuration function}}
...
\doxysubsubsubsubsubsection{GPIO\_PinAFConfig()}
