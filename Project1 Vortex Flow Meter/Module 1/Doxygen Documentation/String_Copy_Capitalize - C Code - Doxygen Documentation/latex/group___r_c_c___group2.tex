...
\label{group___r_c_c___group2}\index{System AHB and APB busses clocks configuration functions@{System AHB and APB busses clocks configuration functions}}
...
\doxysubsubsubsubsubsection{RCC\_GetClocksFreq()}
...
\doxysubsubsubsubsubsection{RCC\_GetSYSCLKSource()}
...
\doxysubsubsubsubsubsection{RCC\_HCLKConfig()}
...
\doxysubsubsubsubsubsection{RCC\_PCLK1Config()}
...
\doxysubsubsubsubsubsection{RCC\_PCLK2Config()}
...
\doxysubsubsubsubsubsection{RCC\_SYSCLKConfig()}
